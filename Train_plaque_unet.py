...
if __name__ == '__main__':
    ...
    stage = 4
    filters = 64
    datapath = './npydata_25patients_aug_1126'

    note = 'UNet'

    lognoteDir = './log_25_patients_aug_1126'
    ...
    model_checkpoint = ModelCheckpoint(os.path.join(lognoteDir, note+'.hdf5'), monitor='val_DSC2D', mode='max', verbose=1, save_best_only=True)
    ...
    # model.load_weights(os.path.join(lognoteDi_fs64_stg4r, 'pre_plaque_UNet_fs64_stg4.hdf5'))
