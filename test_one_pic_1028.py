...
if __name__ == '__main__':
    ...
    data_csv = '../Get2DSegData/1029/Datalist_3patients_1029.csv'
    data_root = '../Get2DSegData'
    note = 'results/results_3_1029'
    ...
    with open(data_csv, 'r') as f:
        ...
        for row in reader:
            ...
            area_pre = int(np.sum(pred_binary))*float(res)
            area_pre_list.append(area_pre*0.065)
    ...
    dataframe = pd.DataFrame({'image_filenames': image_list,
                              ...
                              'miny': miny_list,
                              'maxy': maxy_list,
                              'plaque_areas_pred': area_pre_list,})
